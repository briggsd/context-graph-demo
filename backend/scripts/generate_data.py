"""Generate sample data for Software Engineering context graph."""
...
async def main():
    print("Seeding Software Engineering context graph...")
    ...
    await close_neo4j()
    print("\nDone! Your Software Engineering context graph is ready.")
